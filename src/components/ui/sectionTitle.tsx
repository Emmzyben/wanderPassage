...
const SubTitle = ({ children, className, style }: { children: ReactNode; className?: string; style?: React.CSSProperties }) => {
    return <span className={`wow slideUp ${className}`} style={style}>{children}</span>
}
