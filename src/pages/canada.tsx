    ...
    return (
        <div className="canada-page">
            <PageTitle
                ...
                currentPage="Canada"
                backgroundImage="https://images.unsplash.com/photo-1517090504586-fde19ea6066f?q=80&w=1530&auto=format&fit=crop"
            />
            ...
            <section className="cta-section section-padding">
                <div className="container">
                    <div className="cta-banner-modern">
                        ...
                        <div className="cta-image" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1503614472-8c93d56e92ce?q=80&w=1471&auto=format&fit=crop")' }}></div>
                    </div>
                </div>
            </section>
        </div>
